...
function Start-Infra {
    Write-Info "Docker Compose: Postgres, Redis, MailHog..."
    ...
    Write-Info "Ждём healthy у Postgres и Redis..."
    ...
    throw "Postgres/Redis не стали healthy за 90 с. docker compose ps"
}
